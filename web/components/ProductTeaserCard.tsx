...
export const ProductTeaserCard = (props: ProductTeaserCardProps) => {
  const {
    dailyVolume = "5+",
    dailyVolumeLabel = "YEARS OF CODING",
    headline = "Java Developer & Creative Explorer",
    subheadline = "Building robust backend systems while exploring the world through photography, cycling, and fitness. Passionate about clean code, continuous learning, and crafting tools that make life easier.",
    description = "Full-stack developer specializing in Java ecosystem, with interests spanning from system architecture to creative hobbies.",
