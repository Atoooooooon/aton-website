        ...
        <div className="grid grid-cols-12 gap-5 gap-y-16">
          <div className="col-span-12 md:col-span-6 relative z-10">
            ...
            >
              ...
              >
                crafting elegant solutions for complex problems while staying curious about the world.
              </span>
            </h2>
            ...
            >
              As a Java developer with diverse interests, I bring technical expertise and creative thinking to every project—from backend architecture to photography compositions.
            </p>
