...
type PhotoService interface {
	Create(req *model.CreatePhotoRequest) (*model.Photo, error)
	GetByID(id uint) (*model.Photo, error)
	List(filters repository.PhotoFilters) ([]model.Photo, int64, error)
	Update(id uint, req *model.UpdatePhotoRequest) (*model.Photo, error)
...
func (s *photoService) Create(req *model.CreatePhotoRequest) (*model.Photo, error) {
	// Validate input
...
func (s *photoService) GetByID(id uint) (*model.Photo, error) {
...
func (s *photoService) List(filters repository.PhotoFilters) ([]model.Photo, int64, error) {
	return s.repo.List(filters)
}

func (s *photoService) Update(id uint, req *model.UpdatePhotoRequest) (*model.Photo, error) {
	// Get existing photo
	photo, err := s.repo.GetByID(id)
	if err != nil {
		return nil, ErrPhotoNotFound
...
func (s *photoService) validateCreateRequest(req *model.CreatePhotoRequest) error {
...
func (s *photoService) validateUpdateRequest(req *model.UpdatePhotoRequest) error {
